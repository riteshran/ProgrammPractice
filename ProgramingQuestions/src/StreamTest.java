	...
	public static void main(String[] args) {
      ...
      *****************************************************/
       ...
       *****************************************************/
       ...
       Comparator<Employee> compareByIDtheByName = Comparator.comparing(Employee::getId).thenComparing(Employee::getName);
       List<Employee> al6 = al4.stream().sorted(compareByIDtheByName).collect(Collectors.toList());
